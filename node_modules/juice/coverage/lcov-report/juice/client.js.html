...
<html lang="en">
<head>
    <title>Code coverage report for juice\client.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">juice\client.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.34% <small>(184 / 193)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">89.57% <small>(103 / 115)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(25 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">97.35% <small>(184 / 189)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">juice\</a> &#187; client.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options &amp;&amp; options.xmlMode) {
...
&nbsp;
  if (options.insertPreservedExtraCss &amp;&amp; options.extraCss) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (preservedText) {
      var $appendTo = null;
      if (options.insertPreservedExtraCss !== true) {
        $appendTo = $(options.insertPreservedExtraCss);
      } else {
        $appendTo = $('head');
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!$appendTo.length) { <span class="cstat-no" title="statement not covered" >$appendTo = $('body'); </span>}
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!$appendTo.length) { <span class="cstat-no" title="statement not covered" >$appendTo = $.root(); </span>}
      }
&nbsp;
...
&nbsp;
  function setDimensionAttrs(el, dimension) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!el.name) { <span class="cstat-no" title="statement not covered" >return; </span>}
    var elName = el.name.toUpperCase();
    if (juiceClient[dimension + 'Elements'].indexOf(elName) &gt; -1) {
      for (var i in el.styleProps) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (el.styleProps[i].prop === dimension) {
...
&nbsp;
    if (juiceClient.tableElements.indexOf(elName) &gt; -1) {
      for (var i in el.styleProps) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (styleProps.indexOf(el.styleProps[i].prop) &gt; -1) {
...
function parseContent(content) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (content === 'none' || content === 'normal') {
...
function getPseudoElementType(selector) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (selector.length === 0) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon May 23 2016 11:56:31 GMT-0500 (Central Daylight Time)</div>
</div>
